...
\email{$^\dagger$cecilia.aguilarand@uanl.edu.mx, $^\ddagger$alexander.esproncedago@uanl.edu.mx, $^\ast$elisa.schaeffer(AT)uanl.edu.mx}
...
\conference{\raisebox{0mm}[0cm]{\includegraphics[width=50mm]{img/qr-code-Poster.png}}
  ...
  \hfill
  \raisebox{10mm}[0cm]{\includegraphics[width=100mm]{img/Provericyt-2021.png}}
  \hfill
  \raisebox{10mm}[0cm]{\includegraphics[width=100mm]{img/Verano-Logo.png}}
  }
